...
def init_mongodb():
    ...
    global requests_collection, post_counter_collection
...
def send_media_post(title, media_id, media_type, links, channel_id, channel_name, post_number=None):
    ...
    # Video request button with inline keyboard
    inline_keyboard = {
        'inline_keyboard': [
            [
...
def handle_admin_flow(chat_id, text, message, state):
    ...
    # Channel media - No title step
        ...
        # Store media info and move directly to URLs
        USER_STATE[chat_id]['data'] = {
